    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Edytuj sprzęt">
      {showDeleteConfirm ? (
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <label className="block text-sm font-semibold text-gray-700 mb-2">Nazwa sprzętu:</label>
            <input
              type="text"
              name="name"
              value={formData.name}
          ...
          <div>
            <label className="block text-sm font-semibold text-gray-700 mb-2">Typ sprzętu:</label>
            <select
              name="type"
              value={formData.type}
              onChange={handleChange}
              required
              className="glass w-full px-4 py-3 rounded-xl outline-none border border-gray-300 focus:ring-2 focus:ring-blue-200 focus:border-blue-400 transition-all duration-200 cursor-pointer">
          ...
          <div>
            <label className="block text-sm font-semibold text-gray-700 mb-2">Cena za dobę (PLN):</label>
            <input
              type="number"
              name="pricePerDay"
          ...
          <div className="p-4 glass rounded-xl">
            <h4 className="font-semibold text-gray-700 mb-2">Podgląd:</h4>
